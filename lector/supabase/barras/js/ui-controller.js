...
const UIController = {
  ...
  updateStep2Progress(page, count) {
    this.updateStepDetails(2, `<i class="fas fa-spinner fa-spin"></i> Página ${page}: ${count.toLocaleString()} registros`);
  },

  completeStep2(totalCount) {
    this.setStepComplete(2);
    this.updateStepDetails(2, `✓ ${totalCount.toLocaleString()} registros en base de datos`);
  },
