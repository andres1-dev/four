...
function showSisproUpdateModal() {
    ...
    const modal = createModal(
        `<i class="codicon codicon-sync"></i> Sincronización Maestra SISPROWEB`,
        `<div id="sisproUpdateContent"></div>`,
        true
    );
    modal.classList.add('modal-sispro-update');
    
    // Forzado de centrado perfecto
    ...
    if (content) {
        ...
        content.style.padding = '0'; // Dejar que el container interno maneje el padding
    }
