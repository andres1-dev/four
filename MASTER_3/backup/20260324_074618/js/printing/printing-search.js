...
function print_confirmarImpresionSelectiva(recBuscado) {
    ...
    const duplexEnabled = document.getElementById("printDuplex") ? document.getElementById("printDuplex").checked : true;
    ...
    if (elementsToPrint.length > 0) {
        print_imprimirLoteDocumentos(elementsToPrint, `Impresión Selectiva REC ${recBuscado}`, { duplex: duplexEnabled });
    }
...
function print_buscarLoteRECs() {
    ...
    if (foundItems.length > 0) {
        const duplexEnabled = document.getElementById("printDuplex") ? document.getElementById("printDuplex").checked : true;
        print_imprimirLoteDocumentos(foundItems, 'Impresión Múltiple', { duplex: duplexEnabled });
    }
...
function print_imprimirSoloClientes() {
    ...
    if (itemsParaLote.length > 0) {
        ...
        print_imprimirLoteDocumentos(itemsParaLote, tituloClientes, { duplex: duplexEnabled });
