        ...
        grid.updateConfig({
            data: filteredData.map(f => {
                ...
                return [
                    ...
                    f.entregas.length > 0 && f.entregas[0].Url_Ih3 ? gridjs.html(`<div class="soporte-img"><a href="${f.entregas[0].Url_Ih3}" target="_blank"><img src="${f.entregas[0].Url_Ih3}" alt="Soporte" /></a></div>`) : '-'
                ];
            })
        }).forceRender();
    }
                    ...
                    ${esEntregado && entregas[0].Url_Ih3 ? `
                        ...
                        <div class="collapse" id="${collapseSoporteId}">
                            <div class="collapsible-content p-0 overflow-hidden">
                                <a href="${entregas[0].Url_Ih3}" target="_blank">
