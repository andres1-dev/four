...
const BIOMETRY = {
    ...
    async register() {
        try {
            ...
            const userId = new TextEncoder().encode(session.usuario);
            ...
            if (credential) {
                ...
                localStorage.setItem('tdm_biometric_id', credentialIdB64);
    ...
    remove() {
        localStorage.removeItem('tdm_biometric_id');
        localStorage.removeItem('tdm_biometric_user');
    },

    // Verificar si ya está registrado
    isRegistered() {
        return !!localStorage.getItem('tdm_biometric_id');
    },
