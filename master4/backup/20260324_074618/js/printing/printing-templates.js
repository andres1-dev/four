...
function print_imprimirLoteDocumentos(listaProcesada, titulo = null, options = {}) {
    ...
    const duplex = options.duplex !== undefined ? options.duplex : true;
    const ventana = window.open('', '_blank');
...
function print_getEstilosOriginales(esLote = false, duplex = true) {
    ...
    <style>
        ...
        @media print {
            ...
            .lote-separator {
                ${duplex ? 'break-before: right !important; page-break-before: right !important;' : 'break-before: page !important; page-break-before: always !important;'}
            }
