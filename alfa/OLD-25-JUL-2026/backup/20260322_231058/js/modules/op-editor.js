...
async function saveToSheets() {
    ...
    // Fila sutil y armónica debajo de TOTAL GENERAL
    const tableFooterHTML = `
        <tr>
            <td style="text-align: center; padding: 12px; color: var(--text-secondary); font-weight: 600; font-size: 11px;">COSTO TOTAL (ESTIMADO)</td>
            <td style="text-align: center; padding: 12px; color: var(--info); font-weight: 700; font-size: 15px;">${costoFormateado}</td>
        </tr>
    `;
