// js/script.js - PUNTO DE ENTRADA ÚNICO

// ============================================
// INICIALIZACIÓN - CUANDO EL DOM ESTÉ LISTO
// ============================================
document.addEventListener('DOMContentLoaded', function () {
    Logger.info('script', '🚀 Inicializando aplicación...');
    ...
    Logger.success('script', '✅ Aplicación inicializada');
});
...
function setupAllEventListeners() {
    Logger.info('script', '🔧 Configurando event listeners...');
    ...
    if (bolsasInput) {
        bolsasInput.addEventListener('focus', function() {
            if (this.value === '0') this.value = '';
        });
        bolsasInput.addEventListener('blur', function() {
    ...
    Logger.success('script', '✅ Event listeners configurados');
}
