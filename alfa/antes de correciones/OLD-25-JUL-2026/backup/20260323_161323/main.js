...
document.addEventListener('DOMContentLoaded', function () {
    Logger.info('main', '🚀 Inicializando aplicación...');
    ...
    Logger.success('main', '✅ Aplicación inicializada');
});
...
function setupAllEventListeners() {
    Logger.info('main', '🔧 Configurando event listeners...');
    ...
    Logger.success('main', '✅ Event listeners configurados');
}
