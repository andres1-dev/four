...
function _buildClienteFormModal() {
    ...
    overlay.innerHTML = `
        <div style="background:var(--editor);border:1px solid var(--border);border-radius:8px;width:560px;max-width:95vw;max-height:90vh;overflow-y:auto;box-shadow:0 20px 60px rgba(0,0,0,0.5);">
